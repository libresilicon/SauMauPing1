...
`endif
    ...
    // Command and Address
    integer   TZQCS            = max( 64, ceil( 80000/tck_avg));   // tZQCS      tCK   ZQ Cal (Short) time
    integer   TZQINIT          =  max(512, ceil(640000/tck_avg));  // tZQinit    tCK   ZQ Cal (Long) time
    integer   TZQOPER          =  max(256, ceil(320000/tck_avg));  // tZQoper    tCK   ZQ Cal (Long) time
