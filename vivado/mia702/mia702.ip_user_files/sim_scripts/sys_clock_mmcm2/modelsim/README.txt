...
#
# Generated by export_simulation on Tue Jul 03 01:01:05 HKT 2018
#
################################################################################
...
'-reset_run' switch to the './sys_clock_mmcm2.sh' script.

./sys_clock_mmcm2.sh -reset_run
...
./sys_clock_mmcm2.sh -noclean_files

For more information on the script, please type './sys_clock_mmcm2.sh -help'.
